...
pygame.mixer.init()
hitPaddle = pygame.mixer.Sound('pong/pongTestFiles/sounds/bruh.wav')
aiScored = pygame.mixer.Sound('pong/pongTestFiles/sounds/oof.wav')
playerScored = pygame.mixer.Sound('pong/pongTestFiles/sounds/hyesz.wav')
win = pygame.mixer.Sound('pong/pongTestFiles/sounds/victory.wav')
lose = pygame.mixer.Sound('pong/pongTestFiles/sounds/defeat.wav')
